...
export const studyPlanService = {
    ...
    async _generateTasks({ topic, dailyMinutes, documents }) {
        ...
        const { content } = await llm.complete([
            {
                role: 'system',
                content: 'You are a medical study planner. Generate a weekly study plan. Return ONLY a JSON array of tasks with "title" and "durationMin". Produce 5-7 tasks covering reading, flashcards, and practice questions. Keep titles short.',
            },
            {
                role: 'user',
...
//# sourceMappingURL=studyPlan.service.js.map
...
export const studyPlanController = {
    ...
    updateTask: asyncHandler(async (req, res) => {
        const plan = await studyPlanService.updateTask(req.user._id, req.params.id, req.params.taskId, { completed: req.body.completed });
...
//# sourceMappingURL=studyPlan.controller.js.map
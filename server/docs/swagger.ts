...
export const OPENAPI_SPEC: Record<string, any> = {
  openapi: '3.0.3',
  info: {
    title: 'PhysioMind API',
    version: '1.0.0',
    description:
      'Intelligence Beyond Reading — AI-powered study platform for physiotherapy students. Upload PDFs, generate summaries/quizzes/flashcards/exams/study plans, chat with your documents, and track exam readiness.',
